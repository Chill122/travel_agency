...
ActiveRecord::Schema.define(version: 20180415195725) do
  ...
  add_index "accommodations", ["place_id"], name: "index_accommodations_on_place_id"
  ...
  add_index "reservations", ["offer_id"], name: "index_reservations_on_offer_id"
