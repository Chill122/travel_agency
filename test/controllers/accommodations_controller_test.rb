...
class AccommodationsControllerTest < ActionController::TestCase
  ...
  test "should create accommodation" do
    assert_difference('Accommodation.count') do
      post :create, accommodation: { address: @accommodation.address, description: @accommodation.description, rating: @accommodation.rating, title: @accommodation.title, type: @accommodation.type }
    end
  ...
  test "should update accommodation" do
    patch :update, id: @accommodation, accommodation: { address: @accommodation.address, description: @accommodation.description, rating: @accommodation.rating, title: @accommodation.title, type: @accommodation.type }
    assert_redirected_to accommodation_path(assigns(:accommodation))
  end
